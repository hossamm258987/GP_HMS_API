using AutoMapper;
using PayrollServices_API.Data;
...
namespace PayrollServices_API.Repository
{
    public class PayrollRepository : IPayrollRepository
    {
        ...
        public async Task<PayrollDTO> CreateUpdatePayroll(PayrollDTO payrollDTO)
        {
            ...
            if (emp == null)
            {
                _db.Employees.Add(payroll.employee);
            ...
            payroll.NetSalary = ((payroll.employee.Salary/30) * daysByMonth.Count) + (payroll.IncentiveAmount * payroll.employee.Salary) - (payroll.Tax * payroll.employee.Salary) - (payroll.employee.Factor * payroll.employee.Salary) - dect;
